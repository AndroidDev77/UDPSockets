...
execute_process(
  COMMAND "/usr/bin/git" show-ref latest-passing-build
  WORKING_DIRECTORY "/home/chris/binaryParser/build/_deps/cpputest-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/latest-passing-build")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "latest-passing-build")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "latest-passing-build")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 latest-passing-build
  WORKING_DIRECTORY "/home/chris/binaryParser/build/_deps/cpputest-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/cpputest/cpputest.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/chris/binaryParser/build/_deps/cpputest-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/chris/binaryParser/build/_deps/cpputest-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
